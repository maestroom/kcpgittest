...
class LoginFormAdmin extends CFormModel
{
	...
	public function authenticate($attribute,$params)
	{
		...
		$this->_identity=new UserIdentity($this->username,$this->password);
                ...
                $login_result = $this->_identity->authenticate();
                ...
                elseif($login_result == 2)
                    ...
                    $this->addError('username','Invalid username or password');
                elseif($login_result == 3) // if admin user blocked
                    $this->addError('username', 'Your account is currently blocked!');
                elseif($login_result == 4) // if login attempt failed
