...
/**
 * This is the model class for table "property_photos".
 *
 * The followings are the available columns in table 'property_photos':
 * @property integer $id
 ...
 */
class PropertyPhotos extends CActiveRecord
{
	/**
	 ...
	 * @return PropertyPhotos the static model class
	 */
