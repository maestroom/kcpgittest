...
class PropertyneighbourhoodsController extends Controller
{
	/**
	...
	*/
	public function actionCreate()
	{
            ...
            $model=new PropertyNeighbourhoods;

            if(isset($_POST['PropertyNeighbourhoods']))
            {
                $model->attributes=$_POST['PropertyNeighbourhoods'];
                ...
                if($model->save())
                {
                    ...
                    if(isset($attachments) && count($attachments) > 0)
                    {
                        ...
                        { 
                            $file_name = $model->id."_neighbour.".$doc->getExtensionName();
                            ...
                            if($doc->saveAs(Yii::getPathOfAlias('webroot').$path))
                            {
                                ...
                                {
                                    PropertyNeighbourhoods::model()->updateByPk($model->id, array('path'=>$path));
                                }
                            }    
                        }
                    }
	...
	*/
	...
	{
		$dataProvider=new CActiveDataProvider('PropertyNeighbourhoods');
	...
	*/
	public function actionAdmin()
	{
            ...
            $model=new PropertyNeighbourhoods('search');
            $model->unsetAttributes();  // clear any default values
            if(isset($_GET['PropertyNeighbourhoods']))
                    $model->attributes=$_GET['PropertyNeighbourhoods'];
	...
	* @return PropertyNeighbourhoods the loaded model
	* @throws CHttpException
	*/
	public function loadModel($id)
	{
		$model=PropertyNeighbourhoods::model()->findByPk($id);
		if($model===null)
	...
	* @param PropertyNeighbourhoods $model the model to be validated
	*/
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='property-neighbourhoods-form')
		{
