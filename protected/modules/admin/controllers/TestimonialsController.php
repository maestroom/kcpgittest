	...
	*/
	public function actionCreate()
	{
		...
		if(isset($_POST['Testimonials']))
		{
                    ...
                    {
                        $model->path = '/uploads/testimonials/default.jpg';
                    }
                    else
                    {
                        $model->path = '';
                    ...
                    if($model->save())
                    {
                        ...
                        if(isset($attachments) && count($attachments) > 0)
                        {
                            ...
                            if(!is_dir(Yii::getPathOfAlias('webroot').'/uploads/testimonials'))
                            {
                                mkdir(Yii::getPathOfAlias('webroot').'/uploads/testimonials');
                            }


                            foreach ($attachments as $file => $doc)
                            { 
                                $file_name = $model->id."_testimonials.".$doc->getExtensionName();
                                ...
                                if($doc->saveAs(Yii::getPathOfAlias('webroot').$path))
                                {
                                    ...
                                    {
                                        Testimonials::model()->updateByPk($model->id, array('path'=>$path));
                                    }
                                }    
                            }
                        }
