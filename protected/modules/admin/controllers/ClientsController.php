	...
	*/
	public function actionCreate()
	{
		...
		if(isset($_POST['Clients']))
		{
                    ...
                    {
                        $model->path = '/uploads/clients/default.jpg';
                    }
                    else
                    {
                        $model->path = '';
                    ...
                    if($model->save())
                    {
                        ...
                        if(isset($attachments) && count($attachments) > 0)
                        {
                            ...
                            if(!is_dir(Yii::getPathOfAlias('webroot').'/uploads/clients'))
                            {
                                mkdir(Yii::getPathOfAlias('webroot').'/uploads/clients');
                            }


                            foreach ($attachments as $file => $doc)
                            { 
                                $file_name = $model->id."_client.".$doc->getExtensionName();
                                ...
                                if($doc->saveAs(Yii::getPathOfAlias('webroot').$path))
                                {
                                    ...
                                    {
                                        Clients::model()->updateByPk($model->id, array('path'=>$path));
                                    }
                                }    
                            }
                        }
