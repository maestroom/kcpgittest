...
class PropertyphotosController extends Controller
{
	...
	*/
	public function actionCreate()
	{
            ...
            if(isset($_POST['PropertyPhotos']))
            {
                $model->attributes=$_POST['PropertyPhotos'];
                ...
                if($model->save())
                {
                    ...
                    if(isset($attachments) && count($attachments) > 0)
                    {
                        ...
                        { 
                            $file_name = $model->id."_photos.".$doc->getExtensionName();
                            ...
                            if($doc->saveAs(Yii::getPathOfAlias('webroot').$path))
                            {
                                ...
                                {
                                    PropertyPhotos::model()->updateByPk($model->id, array('path'=>$path));
                                }
                            }    
                        }
                    }
	...
	*/
	...
	{
		$dataProvider=new CActiveDataProvider('PropertyPhotos');
	...
	*/
	public function actionAdmin()
	{
            ...
            $model=new PropertyPhotos('search');
            $model->unsetAttributes();  // clear any default values
            if(isset($_GET['PropertyPhotos']))
                    $model->attributes=$_GET['PropertyPhotos'];
	...
	* @return PropertyPhotos the loaded model
	* @throws CHttpException
	*/
	public function loadModel($id)
	{
		$model=PropertyPhotos::model()->findByPk($id);
		if($model===null)
	...
	* @param PropertyPhotos $model the model to be validated
	*/
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='property-photos-form')
		{
