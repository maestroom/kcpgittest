...
<?php echo BsHtml::pageHeader('Manage','Property Gallery ('.$property_name.')') ?>
    ...
    <div class="panel-body">
        ...
        <br />
            <span style="float:right;">
                ...
                <a href="<?php echo Yii::app()->createUrl('admin/propertygallery/create', array('propertyid'=>$property_id)); ?>" class="btn btn-xs btn-primary"> Add New </a>
            </span>
        <br /><br />
        ...
        <?php $this->widget('bootstrap.widgets.BsGridView',array(
			...
			'columns'=>array(
                                            ...
                                            array('header'=>'Image','type'=>'raw','value' =>'(!empty($data->path)) ? CHtml::image(Yii::app()->baseUrl.$data->path,"",array("style"=>"width:177px;height:100px;")):"No Image"'),
                                            'view_order',
                                            ...
                                            array(
                                                    ...
                                                    'buttons'=>array(       
                                                                        'update' => array(
                                                                                        'label'=>'Update',
                                                                                        'url'=>'Yii::app()->createAbsoluteUrl("admin/propertygallery/update", array("id"=>$data->id,"propertyid"=>$data->property_id))',
                                                                                    ),
                                                                    ),                
                                                ),
                                    ),
