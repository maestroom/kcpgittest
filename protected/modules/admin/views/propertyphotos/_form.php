<?php $form=$this->beginWidget('bootstrap.widgets.BsActiveForm', array(
    ...
    <div class="form-group">
        <label >Image </label> (image should be 260 * 155 size for better view in website)
        <?php
    ...
    <a href="<?php echo Yii::app()->createUrl('admin/propertyphotos/admin', array('propertyid'=>$property_id)); ?>" class="btn btn-danger"> Cancel </a>
