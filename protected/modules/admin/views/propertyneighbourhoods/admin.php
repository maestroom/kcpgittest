...
<?php echo BsHtml::pageHeader('Manage','Property Neighbourhoods ('.$property_name.')') ?>
    ...
    <div class="panel-body">
        ...
        <br />
            <span style="float:right;">
                ...
                <a href="<?php echo Yii::app()->createUrl('admin/propertyneighbourhoods/create', array('propertyid'=>$property_id)); ?>" class="btn btn-xs btn-primary"> Add New </a>
            </span>
        <br /><br />

        <?php $this->widget('bootstrap.widgets.BsGridView',array(
			'id'=>'property-neighbourhoods-grid',
			...
			'columns'=>array(
                                            ...
                                            array(
                                                    ...
                                                    'buttons'=>array(       
                                                                        'update' => array(
                                                                                        'label'=>'Update',
                                                                                        'url'=>'Yii::app()->createAbsoluteUrl("admin/propertyneighbourhoods/update", array("id"=>$data->id,"propertyid"=>$data->property_id))',
                                                                                    ),
                                                                    ),                
                                                ),
                                    ),
