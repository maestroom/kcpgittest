<?php $form=$this->beginWidget('bootstrap.widgets.BsActiveForm', array(
    ...
    <div class="form-group">
        <label >Image </label> (to be displayed in home page banner, image should be 185 * 80 size for better view in website)
        <?php
                if(isset($model->path) && $model->path!='')
                {
                    echo BsHtml::imageResponsive(Yii::app()->baseUrl.$model->path, 'No Image Found', array('style' => 'width = 180px; height: 80px')); 
                }
